CLASS zcl_po_drv_class DEFINITION
  PUBLIC
 FINAL
  CREATE PUBLIC .
...
CLASS ZCL_PO_DRV_CLASS IMPLEMENTATION.
...
SELECT a~PurchaseOrder,
  ...
  WHERE a~PurchaseOrder = @po_num and (   e~ConditionType = 'PMP0' or  e~ConditionType = 'PPR0' )
 ...
 """""""""""""""""" discount """"""""""""""""""""""""""
  ...
  LEFT JOIN i_purordpricingelementtp_2  AS e  " Corrected view name
    ON b~PurchaseOrder = e~PurchaseOrder
    AND b~PurchaseOrderItem = e~PurchaseOrderItem
  WHERE a~PurchaseOrder = @po_num and  ( e~ConditionType = 'ZDCP' OR e~ConditionType = 'ZDCQ' )
