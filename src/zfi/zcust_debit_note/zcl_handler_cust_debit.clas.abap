CLASS zcl_handler_cust_debit DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_handler_cust_debit IMPLEMENTATION.
...
*     req_uri = request->get_request_uri( ).
    ...
    req_uri = '/sap/bc/http/sap/ZHTTP_CUST_DEBIT?sap-client=080'.
    ...
    CASE request->get_method( ).
      ...
      WHEN CONV string( if_web_http_client=>post ).
        ...
        IF lv_ac IS NOT INITIAL.
          ...
          TRY.
              DATA(pdf) = zcl_cust_debit=>read_posts( accounting_no = ac  Company_code = cc fiscal_year = fs ).
              IF  pdf = 'ERROR'.
