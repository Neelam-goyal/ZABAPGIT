CLASS zcl_http_fi_voucher_print DEFINITION
...
CLASS ZCL_HTTP_FI_VOUCHER_PRINT IMPLEMENTATION.
...
*                 '<form action="/sap/bc/http/sap/ZHTTP_VOUCHER_PRINT" method="POST" target = _blank>'
                 ...
                 '<form action="/sap/bc/http/sap/zcl_http_fi_voucher_print" method="POST">'
